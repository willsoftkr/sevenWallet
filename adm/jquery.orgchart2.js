...
//		return;
    ...
    createNode: function (nodeData, level, opts) {
      ...
      if (opts.nodeTemplate) {
        ...
        var html = '<div class="title"><div align=right style="padding:0px 2px 0px 0px;text-align:center;"><img src="/img/go.png" onclick="go_member(\''+temp[2]+'\')"><img src="/img/edit.png" style="float:right" onclick="edit_member(\''+temp[2]+'\')"></div>';
        html += '<div style="display:none;dlear:both;height:20px;text-align:center;letter-spacing: -4px;">';
        if(temp[9] > 0){
        ...
        html += '</div>';
        html +='<p class="mb" style="margin-top:20px;">' 
        ...
        if(temp[17] == 'B'){
          ...
          html += '<div class="dec"><strong>Pointdd Right:</strong> <span class="orange">' + temp[8] + '</span></div>';
        }
