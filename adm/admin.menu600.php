...
$menu['menu600'] = array (
    ...
    array('600000', '마케팅플랜', ''.G5_ADMIN_URL.'/allowance_sett.php','allowance_sett'),
    array('600050', '수당 비율 설정', G5_ADMIN_URL.'/v7.daily.cond.php', 'bbs_board'),
	array('600080', '전환 매출 설정', G5_ADMIN_URL.'/config_price.php', 'bbs_board'),
