...
function save_benefit($to_date, $mbid, $mbno,$mbname, $recom, $allowance_name, $benefit, $rec_adm, $rec, $grade,$v7_account,$grade_update = 0 ){
	...
	$balance_up = "update g5_member set mb_balance = round(mb_balance+ ".$benefit.", 2), mb_v7_account = round(mb_v7_account+ ".$benefit."/".$v7_cost.",3), grade = '{$grade}'   where mb_id = '".$mbid."';";
