...
if ($srow[b_recomm]){
	...
	echo $sql  = "select (mb_my_sales+habu_day_sales) as tpv from g5_member where mb_id ='".$srow[b_recomm]."' and sales_day='".date("Y-m-d")."'";
	$row6 = sql_fetch($sql);
...
echo '<br>';
    echo $sql  = "select (mb_my_sales+habu_day_sales) as tpv from g5_member where mb_id ='".$srow[b_recomm2]."' and sales_day='".date("Y-m-d")."'";
	$row7 = sql_fetch($sql);
