				...
				<div>
					...
					<ul class="clear_fix pw_ul">
						<li>
							...
							<ul>
								<li class="x_li" id="pm_1">8자 이상 20자 이하</li>
								<li class="x_li" id="pm_2">영문 대문자와 소문자 조합</li>
								<li class="x_li" id="pm_3">숫자</li>
								<li class="x_li" id="pm_4">특수 기호</li>
							</ul>
						</li>
						<li>
							<input type="password" minlength="8" maxlength="20" id="reg_tr_password" placeholder="트랜잭션 비밀번호"/>
							<input type="password" minlength="8" maxlength="20" id="reg_tr_password_re" placeholder="트랜잭션 비밀번호 확인"/>
							
							<strong>강도 높은 비밀번호 설정 조건</strong>
							<ul>
								<li class="x_li" id="pt_1">8자 이상 20자 이하</li>
								<li class="x_li" id="pt_2">영문 대문자와 소문자 조합</li>
								<li class="x_li" id="pt_3">숫자</li>
								<li class="x_li" id="pt_4">특수 기호</li>
							</ul>
						</li>
					</ul>
				</div>
...
<!--					<p class="text_right font_green mb20">업로드 성공</p>-->
					...
					<div class="clear_fix ecode_div">
						...
						<a href="javascript:void(0)" class="" id="sendMail">
...
<!-- 						<input type="text" placeholder="거주 국가 선택"/> -->
					...
					<div class="btn_input_wrap mb10">
						...
						<a href="javascript:getUser();" class="search_result_btn " >추천인 검색</a>
					</div>
					<div class="btn_input_wrap mb10">
