...
<?php include '_include/gnb.php'; ?>
				...
				<ul class="send_con">
					<li>
						<div>
							<div>
								...
								<img class="scan_qr f_right" src="_images/wallet_addr_rock.gif" alt="주소 확인하기">
							</div>
					...
					<li>
						<div>
							...
							<p class="f_right"><span class="font_gray">0.0000</span> Gas</p>
						</div>
					</li>
					<li>
						<div>
							<span class="send_title">개스 가격</span>
							<p class="f_right"><span class="font_gray">0.0000</span> Gwei</p>
						</div>
					</li>
					<li>
						<div>
							<span class="send_title">인출 합계</span>
							<p class="f_right">0.00000 RWD</p>
						</div>
					</li>
				</ul>
	...
	<script>
		$(function() {
			$(".top_title h3").html("<img src='_images/top_send.png' alt='아이콘'> 락우드 보내기");
