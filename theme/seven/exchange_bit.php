...
<?php include '_include/gnb.php'; ?>
		...
		<div class="btn_block_btm_wrap">
			<input type="button" value="환전하기" class="btn_basic exchange_cancel_pop_open pop_open">
	...
	<script>
		$(function() {
			$(".top_title h3").html("<img src='_images/top_exchange.png' alt='아이콘'> 비트코인으로 환전하기");
		});
	</script>
