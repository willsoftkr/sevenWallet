		...
		<header>
			...
			<nav class="left_gnbWrap">
				...
				<div class="gnb_logo_top">
					<a href="/"><img src="<?=G5_THEME_URL?>/_images/gnb_logo.png" alt="v7 wallet"></a>
				</div>
				<ul class="left_gnb">
					<li><a href="/" ><img src="<?=G5_THEME_URL?>/_images/menu01.gif" alt="아이콘" ><span data-i18n="nav.대시보드">dashboard</span></a></li>
					<!--<li><a href="/page.php?id=profile"><img src="<?=G5_THEME_URL?>/_images/menu02.gif" alt="아이콘" ><span data-i18n="nav.개인정보와 보안설정">Profile & Settings</span></a></li>-->
					...
					<li><a href="/page.php?id=support_center"><img src="<?=G5_THEME_URL?>/_images/menu08.gif" alt="아이콘"><span data-i18n="nav.서포트 센터">Support Center</span></a></li>
					<li>
			...
			<div class="top_title">
				...
				<h3><a href="/"><img src="<?=G5_THEME_URL?>/_images/top_dash.png" alt="아이콘"> </a></h3>
			</div>
