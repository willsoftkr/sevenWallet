...
<?php include '_include/gnb.php'; ?>
		...
		<section class="con90_wrap send_etc_wrap">
			<div class="color_block look_block">
				...
				<div class="clear_fix">
					...
					<p class="f_right">1.85521485 LKEI</p>
				</div>
			</div>
				...
				<ul class="send_con">
					<li>
						<div>
							<div>
								...
								<img class="scan_qr f_right" src="_images/wallet_addr_look.gif" alt="주소 확인하기">
							</div>
					...
					<li>
						<div>
							...
							<ul class="money_chage clear_fix mc_look">
								<li>
					...
					<li>
						<div>
							...
							<p class="f_right">0.00245 LKEI</p>
						</div>
					</li>
				</ul>
	...
	<script>
		$(function() {
			$(".top_title h3").html("<img src='_images/top_send.png' alt='아이콘'> 루키코인 보내기");
