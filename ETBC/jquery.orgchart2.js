        ...
        $nodeDiv.append(opts.nodeTemplate(nodeData));
		 ...
		 if (temp[0]=="NO"){
          ...
          .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content">' + (nodeData[opts.nodeContent] || '') + '</div>' : '');
	        ...
	        $nodeDiv.append('<div class="title"><div onclick="go_member(\''+temp[2]+'\')"><div><img src="/img/'+temp[6]+'.gif" width=12 align=absmiddle> <img src="/img/pool/'+temp[8]+'.gif" width=12 align=absmiddle></div><div>' + temp[0] + '</div><div>' + temp[2] + '</div><div style="color:blue"><b>' + temp[3] + '</b></div><div>' + temp[4] + '</div><div>' + temp[5] + '</div><div>' + temp[7] + '</div></div></div>')
          .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content">' + (nodeData[opts.nodeContent] || '') + '</div>' : '');
		 }
      }
