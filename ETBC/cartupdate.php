...
if ($sw_direct)
{
	if ($is_member)
	{
		goto_url("/new/orderform.php?sw_direct=$sw_direct&set_id_sel=$_POST[searchId]&payMethod=$_POST[payMethod]");
	}
	else
	{
		goto_url(G5_BBS_URL."/login.php?url=".urlencode("/new/orderform.php?sw_direct=$sw_direct"));
	}
}
else
{
   goto_url(G5_URL.'/new/purchase_hash_full.php');
}
?>
