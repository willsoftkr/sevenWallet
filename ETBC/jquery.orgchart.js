...
//        return;
    ...
    createNode: function (nodeData, level, opts) {
      ...
      if (opts.nodeTemplate) {
       ...
       // onclick="go_member(\''+temp[2]+'\')">
        var html = '<div class="title"><div align=right style="padding:0px 2px 0px 0px;text-align:center;"><img src="/img/go.png" onclick="go_member(\''+temp[2]+'\')"></div>';
        // +'<div><img src="/img/pool/'+temp[8]+'.gif" width=12 align=absmiddle></div>'
        // + temp[9] + temp[10]
        html += '<div style="clear:both;height:20px;text-align:center;letter-spacing: -4px;">';
        if(temp[9] > 0){
    ...
    //181122    html += '<div class="dec"><strong>Distance: ' + temp[14] + '</strong></div>';
    //181122    html += '<div class="dec"><strong>Sponsored: ' + temp[15] + '</strong></div>';
    //181122    html += '<div class="dec"><strong>Members: ' + temp[16] + '</strong></div>';
        if(temp[17] == 'B'){
          html += '<div class="dec p"><strong>Point Left:</strong> <span class="orange">' + temp[7] + '</span></div>';
          html += '<div class="dec"><strong>Point Right:</strong> <span class="orange">' + temp[8] + '</span></div>';
        }
