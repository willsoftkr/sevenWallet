...
<div style="padding:0px 0px 0px 10px;display:none;">
	...
	<input type="button" class="btn_menu" value="전체 조직도보기" onclick="location.href='level_structure.php?go=Y'">
	...
	<div style="margin-left:10px;padding:5px 5px 5px 5px;border:1px solid #d9d9d9;height:683px">
		...
		<table>
			<tr>
				...
				<input type="text" id="mb_org_num"  name="mb_org_num" value="<?php echo $member[mb_org_num]; ?>" class="frm_input" style="width:40px;text-align:center" size="3" maxlength="3"> 단계 &nbsp;
				</div>
				</td>
			</tr>
			<tr>
...
<span style="font-weight:100;font-size:16px;color:rgb(124,124,124);margin-left:10px;">( 999 Total )<!-- 괄호 토탈값 --></span>
</div>
