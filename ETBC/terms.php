...
Our Agreement This Agreement establishes the legal terms and conditions of the agreement between us (collectively this “Agreement”) on which we sell to you any of the Services (defined below) that are described on our website (the “Site”).

For purposes of this Agreement, “you” or “your” refer to the customer agreeing to the terms and conditions of this Agreement; “us,” “we,” or “our” refer to ETBC Asset Holdings dba eosteamblockchain.net; “Bitcoin” refers to the peer-to-peer internet commodity further described at www.bitcoin.org and “Bitcoins” refers to individual units of Bitcoin.

This Agreement will apply to any Services (defined below). Please read this Agreement carefully and make sure that you understand it before ordering any Services from the Site. Please note that by purchasing a Service, you agree to be bound by this Agreement and the other documents expressly referred to herein. Please execute this Agreement by clicking the button labeled “CREATE NEW ACCOUNT” on the Site version. If you refuse to accept the terms and conditions of this Agreement, you will not be able to purchase a Services, or to access your portal related to an existing Services.

You should print a copy of this Agreement or save it for your future reference.

Every time you purchase a Service, please refer to the most current version of this Agreement made available on the Site to ensure you understand the terms which will apply at that time. This Agreement was most recently updated on October 01, 2018. This Agreement is only in the English language.

1. INFORMATION ABOUT US
1.1. We operate the Site eosteamblockchain.net and our contact is support@eosteamblockchain.net.

2. OUR SERVICES
2.1. Mining Hardware, Services, and Packages. Bitcoin mining hardware (“Mining Hardware”) consists of specialized computing hardware, computer programs, networking interconnectivity and associated facilities that run proprietary Bitcoin mining software (“Software”). We are selling you the specific volume of processing power (the 'Service' or 'Services') of that Mining Hardware corresponding to an amount of processing power (measured in billions of Bitcoin calculations per second or “Gigahashes”) specified in each order for probable, but not guaranteed, opportunity to earn. We rent all Mining Hardware to provide Services to you and our other users (“Users”) and which we also use ourselves for our own account.

2.2. Mining Contracts.
a. When you enter this Agreement to offer us the right to provide you Service, and we accept your offer by sending you an order confirmation (an “Order Confirmation”), a contract (a “Mining Contract”) to provide Service is formed. Upon commencement of Service, we will allocate a part of Mining Hardware equal to a certain amount of Bitcoin mining computer computational power (“Mining Contract Capacity”) to you for your use in mining Bitcoins.
b. The types of Mining Contracts potentially available at any time are described in detail at eosteamblockchain.net. You must have purchased a Mining Contract to have any right to use Services to obtain any right to Product (defined below).

2.3. Rental of Mining Hardware. We provide Services to you and our other Users, including customers who have current and valid Mining Contracts and also to use ourselves for our own account. You acknowledge that by executing this Agreement and reserving a Mining Contract, and by logging into our Site and accessing your account, you are undertaking Bitcoin mining on your behalf only, at your own risk and for your own benefit. In allocating to you the Mining Contract Capacity, we will use commercially reasonable efforts to provide the Mining Hardware on your behalf, partially on behalf of our other Users, and partially on behalf of ourselves. We retain for our own benefit the portion of the total Mining Hardware not allocated through Mining Contracts.

2.4. Mining Product. The Mining Hardware will mine Bitcoins by utilizing Hashing Power. The Bitcoins produced by the Mining Hardware (the “Product”) will be centrally collected by us, and we will distribute a portion of the Product to Users (“Customer Portion”) based upon the Mining Package allocated under valid Mining Contracts held by Users during the period of effectiveness of your Mining Contract (the “Term”), with such distributions subject to Maintenance Fees.

2.5. Distribution of Product Portions. Customer Portions will be distributed to your Bitcoin Credit Wallet (defined below).

2.6. Service Fee. The fee that you pay for the Mining Contract, as described on the website.

2.7. Maintenance fees. A fee that we may charge you daily from your Customer Portion to cover running costs of Mining Hardware, as described on the website. The fee will be converted to the number of Bitcoins based on the previous day's Bitcoin closing price in US$ in the Bitcoin Price Index published on Blockchain.info. eosteamblockchain.com can change the maintenance fee any time with 7 days' notice.

2.8. Termination. Any particular Mining Package Contract shall be terminated after 1000 days and all contracts will be terminated when mining is no longer profitable.

3. YOUR ACCOUNT
3.1. Password. As part of the process of selecting and paying for a Services, you are required to create an account on the Site (“Account”) and to provide your email (“User Name”) and password (“Password”). To protect your Account and to prevent unauthorized access to it, keep your Password confidential. You are responsible for any activity that happens on or through your Account. If you become aware of or suspect any unauthorized use of your Password or Account, please change your Password immediately and notify us immediately. If we believe that there has been unauthorized access to your Account, we reserve the unilateral right to suspend or discontinue any and all Services, your Account, in which event we will endeavor to notify you.

3.2. Bitcoin Wallet. Your “Bitcoin Wallet” is the Bitcoin address that you provide to us from time to time for the payment to you of your Customer Portions. You have no ownership interest in any Bitcoin held by us. We do not operate your Bitcoin Wallet. By entering the Bitcoin wallet address you acknowledge the ownership of it. You are solely responsible for maintaining and controlling your Bitcoin Wallet. Be sure to safeguard the access credentials to your Bitcoin Wallet. Any Product is only as secure as your confidential access credentials. If you forget or misplace your access credentials to your Bitcoin Wallet or if others gain access to your Bitcoin Wallet, with or without your authorization, you could permanently lose your Bitcoins, including any Customer Portions we transfer to your Bitcoin Wallet. To be clear, we have no liability for any operation or failure of your Bitcoin Wallet.
...
d. notify law enforcement, regulatory authorities, impacted third parties and others as we deem appropriate;
...
10.1. Our Right to Change this Agreement. We may change this Agreement, or otherwise modify the terms of use for our Services, or the Term (all such changes and modifications “Changes”), from time to time, including but not limited to in the following circumstances:
...
e. the occurrence of an Event Outside Our Control;
...
10.4. Application of Changes. Unless otherwise provided by this Agreement or applicable Law, Changes will only apply after their effective dates and will not apply retroactively.

10.5. Changes Made for Legal Reasons. Changes made for legal reasons, including but not limited to Changes to comply with any relevant Laws, will be effective immediately. We will contact you as soon as reasonably possible to notify you of such Changes.

11. TERMINATION
11.1. Your Right to Terminate. You may terminate this Agreement and any Service by giving notice of termination to us. We have a strict NO REFUND policy due to the speed at which our compensation structure and mining package earnings are paid out. In most cases, you cannot get a refund for any reason unless there is an undeniable mistake on our end. Also, this refund request must happen within the first 72 hours of payment or before three full pay cycles are paid out. If you make a refund request after this time, we will not be able to honor it.
...
12. OUR LIABILITY TO YOU IS LIMITED TO THE SERVICE FEE
12.1. Exclusions. Nothing in this Agreement limits or excludes our liability for:

a. death or personal injury caused by our negligence; or
b. fraud or fraudulent misrepresentation.
12.2. WAIVER OF CLAIMS AGAINST THE COMPANY'S SUPPLIERS
a. We are your only obligor under this Agreement and in relation to providing you the Service. YOU HEREBY VOLUNTARILY, IRREVOCABLY, AND UNCONDITIONALLY RELEASE, ACQUIT, AND FOREVER DISCHARGE AND FULLY WAIVE YOUR RIGHT TO BRING ANY TYPE OF LAWSUIT, LEGAL ACTION, CHARGE, DEMAND, COMPLAINT OR CLAIM OF ANY TYPE AGAINST ANY OF OUR SUPPLIERS, OR ANYONE OTHER THAN US, RELATING TO THE SERVICE.

b. In some jurisdictions, this waiver of claims against our Suppliers may not be enforceable. To the extent that is the case, the provisions of this Agreement that limit our liability or disclaim warranties also apply to our Suppliers.

12.3. Your Service Fee is at Risk, and There Is No Guarantee That the Service Will Produce Product. The fact that people have benefited from Bitcoin mining in the past is no indication that you will benefit from Bitcoin mining, or from the Service, in the future. You should view your entire Service Fee as being at risk as you enter this Agreement. We make no representation, warranty or guarantee that you will receive Product from the Services.
...
13. INDEMNIFICATION
You agree to indemnify, defend and hold harmless us and the Other Entities, in their individual capacities or otherwise, from and against any third party claims, liability, damages or costs (including reasonable attorneys' fees) arising from (a) your negligence; (b) any claim by a third party (“Third Party Claim”) alleging that your use of our Services violates the rights of any third party, or violates any Law; (c) your failure to comply with the terms of this Agreement; (d) your violation of any applicable Law; (e) your violation of any rights of a third party; or (f) your use of our Services.

14. EVENTS OUTSIDE OUR CONTROL
14.1. Definition. An “Event Outside Our Control” means any act or event beyond our reasonable control, including without limitation any act of God, strikes, lockouts or other industrial action by third parties, civil commotion, riot, invasion, terrorist attack or threat of terrorist attack, war (whether declared or not) or threat or preparation for war, fire, explosion, storm, flood, earthquake, subsidence, epidemic or other natural disaster, failure of public or private telecommunications or power networks, equipment failure, system failure, material change to Law, or change in industry self-regulation regarding Bitcoin, Bitcoin & Altcoin mining or associated services.

14.2. Our Liability.
We will not be liable or responsible for any failure to perform, or delay in performance of, any of our obligations to deliver the Services that is caused by an Event Outside Our Control. 14.3. Effect.
...
14.4. Allocation.
We are also entitled, during Events Outside Our Control, to allocate the disruption or harm across a number of affected Users or Services. You acknowledge that this may reduce your allocated Services and the Customer Portion which is distributed to you. 14.5. Regulation.
We have the right to redeem the current active mining contracts at the current one-time allocation price in order to avoid disputes in connection with entry into force the government regulation (if any) of the Services with 7 days' notice via internal email. 15. HOW DO I RESOLVE DISPUTES ABOUT THE SERVICES?
...
15.3. Raising a Dispute. To raise a Dispute, you must give us notice of the Dispute by sending an e-mail to support@eosteamblockchain.net with the words “RAISING A DISPUTE” in the subject line), along with a written description of your Dispute, including any documents and information that you believe will help us understand your Dispute and your requested resolution. In order to discuss the Dispute with you, you permit us (or the Disputed party) to contact you by phone, text message, email or physical mail through any and all addresses or phone numbers that you have provided. You must send us notice of any Dispute within 30 days of your discovering the act or omission that gave rise to your Dispute. If you do not so notify us, then you lose your right to raise the Dispute.

15.4. Resolution Offer. Within the first 30 days of your submitting your Dispute, we will have the right, but no obligation, to provide you with a proposed resolution of the Dispute (the “Offer”). If you are unsatisfied with the Offer, you must reject the Offer by notice to us within 14 days of the Offer. If you do not reject the Offer within at 14-day period, you will be deemed to have accepted it and forfeit your right to raise the Dispute. If we do not make the Offer within 30 days of your submitting your Dispute or if you reject an Offer as set forth above, either you or we may commence arbitration of the Dispute as set forth below.

15.5. Place and Language. The arbitration proceeding shall be conducted in the English language, in the US. We shall choose the arbitration service to be used for the Dispute.
...
16.5. Third Party Beneficiaries. No other person, other than you, shall have any rights to enforce this Agreement or a Service, whether under the Contracts or otherwise.
